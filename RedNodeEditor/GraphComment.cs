...
public class GraphComment
{
    ...
    public void Render()
    {
        ...
        if (Utilities.IsMouseHovering(rectEnd - new Vector2(2.5f, 2.5f), 7) && !GraphEditor.DraggingNode && !GraphEditor.DraggingOutput && !IsResizing)
        {
